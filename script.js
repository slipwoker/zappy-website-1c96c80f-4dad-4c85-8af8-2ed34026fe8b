document.addEventListener('DOMContentLoaded', function() {
    ...
    const navbar = document.querySelector('.navbar, nav, [class*="navbar"], [class*="header"]');
    if (navbar) {
    ...
    if (contactForm) {
        ...
        fields.forEach(function(field) {
            ...
            errorEl.style.cssText = 'color: #e53e3e; font-size: 0.875rem; margin-top: 0.25rem; display: none;';
        ...
        function validateField(field) {
            ...
            if (field.hasAttribute('required') && !value) {
                const label = field.closest('label')?.textContent || field.getAttribute('placeholder') || field.name;
                showError(field, (label ? label + ' ' : '') + 'is required');
                return false;
            }
    ...
    const animatedElements = document.querySelectorAll('[class*="fade-in"], [data-animate], .animate-on-scroll');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1c96c80f-4dad-4c85-8af8-2ed34026fe8b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1c96c80f-4dad-4c85-8af8-2ed34026fe8b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1c96c80f-4dad-4c85-8af8-2ed34026fe8b';
